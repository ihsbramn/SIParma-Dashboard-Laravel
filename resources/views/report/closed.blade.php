...
@section('content')
    ...
    <div class="row" style="margin-top: 30px; padding-left: 20px; padding-right: 20px">
        ...
        <div class="col-4">
            <form action={{ 'datefilter_closed' }} method="GET">
                {{ csrf_field() }}
                <div class="input-group mb-3">
        ...
        <div class="col-1">
            <a class="btn btn-outline-danger" type="button" href="{{ route('report.closed') }}"
                id="button-addon2">Clear</a>
        </div>

        <div class="col">
            <a href={{ 'report.export.closed' }} type="button" class="btn btn-success">
                Download
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                    class="bi bi-file-earmark-excel" viewBox="0 0 16 16" style="margin-bottom: 3px">
                    <path
    ...
    <div class="row" style="padding: 35px; padding-top: 0px; margin-top: 10px">
        ...
        Showing {{ $report->count() }} from total {{ $report->total() }} closed data
    </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                                ...
                                <div class="accordion-body">
                                    Download all report data from database : <a href={{ 'export_excel' }}
                                        class="btn btn-success" style="margin-left: 10px">Download</a>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <form action={{ 'datefilter' }} method="POST">
                                                ...
                                                <div class="input-group mb-3" style="margin-top: 10px">
                                                    ...
                                                    <input type="date" class="form-control" name="to"
                                                        value="{{ date('y-m-d') }}" aria-describedby="button-addon2">
                                                </div>
