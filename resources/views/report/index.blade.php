...
@section('content')
    ...
    <div class="row" style="margin-top: 30px; padding-left: 20px; padding-right: 20px">
        ...
        <div class="col">
            <a href={{ 'report.export' }} type="button" class="btn btn-success" data-bs-toggle="modal"
    ...
    <div class="row" style="padding: 35px; padding-top: 0px; margin-top: 10px">
        ...
        Showing {{ $report->count() }} from total {{ $report->total() }} data
    </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                                ...
                                <div class="accordion-body">
                                    Download all report data from database : <a href={{ 'report.export' }}
                                ...
                                <div class="accordion-body">
                                    ...
                                    <div class="row">
                                        <div class="col" style="text-align: left">
                                            <form action={{ 'report.export.bydate' }}>
                                                {{ csrf_field() }}
