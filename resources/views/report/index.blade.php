    ...
    <div class="row">
        ...
        <div class="col-4">
            <form action={{ 'datefilter' }} method="POST">
                ...
                {{-- <input type="date" class="form-control" id="exampleFormControlInput1" name="from"
                    value="{{ date('y-m-d') }}">
                <input type="date" class="form-control" id="exampleFormControlInput1" name="to"
                    value="{{ date('y-m-d') }}">
    ...
    {{-- <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
                ...
                <li class="page-item disabled">
                    <a class="page-link" href="{{$report->links()}}" tabindex="-1" aria-disabled="true">Previous</a>
                </li>
                <li class="page-item"><a class="page-link" href="#">1</a></li>
                <li class="page-item"><a class="page-link" href="#">2</a></li>
                <li class="page-item"><a class="page-link" href="#">3</a></li>
                <li class="page-item">
                    <a class="page-link" href={{$report->links()}} >Next</a>
                </li>
            </ul>
        </nav> --}}
