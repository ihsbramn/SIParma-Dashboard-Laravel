...
@section('content')
    ...
    <div class="row" style="margin-top: 30px; padding-left: 20px; padding-right: 20px">
        ...
        <div class="col-4">
            <form action={{ 'datefilter_open' }} method="GET">
                {{ csrf_field() }}
                <div class="input-group mb-3">
        ...
        <div class="col-1">
            <a class="btn btn-outline-danger" type="button" href="{{ route('report.open') }}" id="button-addon2">Clear</a>
        </div>

        <div class="col">
            <a href={{ 'report.export.open' }} type="button" class="btn btn-success">
                Download
    ...
    <div class="row" style="padding: 35px; padding-top: 0px; margin-top: 10px">
        ...
        Showing {{ $report->count() }} from total {{ $report->total() }} open data
    </div>
