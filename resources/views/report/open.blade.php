...
@section('content')
    ...
    <div class="row" style="margin-top: 30px; padding-left: 20px; padding-right: 20px">
        ...
        <div class="col-2">
            ...
            <div class="col">
                <a href={{ 'report.export.open' }} type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#ExcelModal">
                    Download
                            ...
                            <div class="accordion" id="accordionExample">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        Download open report data from database : <a href={{ 'report.export.open' }} class="btn btn-success" style="margin-left: 10px">Download</a>
                                    </div>
                                </div>
                                </div>
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            <div class="row">
                                                <div class="col" style="text-align: left">
                                                    <form action={{ 'report.export.open.bydate' }}>
                                                    {{ csrf_field() }}
